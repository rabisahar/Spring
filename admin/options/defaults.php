    ...
    class Redux_Options {
        ...
        */
        function __construct($sections = array(), $args = array(), $extra_tabs = array()) {    
            ...
            $defaults['footer_credit'] = __('<span id="footer-thankyou">Options panel created by <a href="http://www.coopehost.com/" target="_blank">Coope Host</a> v' . $this->framework_version . '</span>', Redux_TEXT_DOMAIN);
