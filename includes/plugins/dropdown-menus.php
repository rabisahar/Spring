...
class DropDown_Nav_Menu extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth, $args ) {
		...
		$class_names = ' class="' . $item->attr_title . '"';
...
class DropDown_Menu_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dropdown-menu-widget', 'description' => __( 'Use this widget to add one of your custom menus as a dropdown.', "coope") );
		parent::__construct( 'dropdown_menu', __('Dropdown Menu', "coope"), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		if ( ! $menus ) {
			echo '<p>'. sprintf( __( 'No menus have been created yet. <a href="%s">Create some</a>.', "coope"), admin_url( 'nav-menus.php' ) ) .'</p>';
			return;
		}
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', "coope" ) ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $title; ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'nav_menu' ); ?>"><?php _e( 'Select Menu:', "coope" ); ?></label>
