...
//                    <div class="container">
//                        <a title="Quick Page Builder" href="http://www.coopehost.com" class="brand" target="_blank"></a>
//                        <div class="nav-collapse">
//                            <ul class="nav">
//                                <li class="dropdown">
//                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_popular_layouts" href="#">'.__("Choose Layout", "js_composer").' <b class="caret"></b></a>
