...
class WPBakeryVisualComposerSetupAdmin extends WPBakeryVisualComposerSetup {
    ...
    public function jsComposerEditPage() {
        ...
        foreach ($pt_array as $pt) {
            add_meta_box( 'wpb_visual_composer', __('Quick Page Builder', "js_composer"), Array($this->composer->getLayout(), 'output'), $pt, 'normal', 'high');
        }
    }
    ...
    public function composerSettings() {
        ...
        if ( current_user_can('manage_options') && $this->composer->isPlugin()) {
            //add_options_page(__("Quick Page Builder Settings", "js_composer"), __("Quick Page Builder", "js_composer"), 'install_plugins', "wpb_vc_settings", array($this, "composerSettingsMenuHTML"));
        }
    }
