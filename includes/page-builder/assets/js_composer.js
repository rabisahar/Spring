...
jQuery(document).ready(function($) {
	...
	*/
	...
	if ( $("#wpb_visual_composer").length == 1 ) {
		$('div#titlediv').after('<p class="composer-switch"><a class="wpb_switch-to-composer button-primary" href="#">Quick Page Builder</a></p>');
		...
		if ( $('#wpb_vc_js_status').val() == 'true' && jQuery('#wp-content-wrap').hasClass('tmce-active') ) {
			...
			postdivrich.show();
			visualcomposer.hide();
			$('.wpb_switch-to-composer').html('Quick Page Builder');
		}
	}
