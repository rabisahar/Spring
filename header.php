...
<?php
		...
		<script>
			WebFontConfig = {
			    google: { families: [<?php echo $custom_fonts; ?> 'Roboto'] }
			};
...
<div id="wrapper" class="main-container">
			...
			<div class="headerinner">
				...
				<div class="nav-drop-down">Menu<div class="arrowicon"><i class="material-icons">arrow_drop_down</i></div></div>
				<div class="nav-drop-down-container">
					<ul class="">
						<li><a href="" class="primary">Primary Page</a></li>
						<li ><a href="" class="secondary">- Secondary Page</a></li>
						<li ><a href="" class="secondary">- Secondary Page</a></li>
						<li><a href=""  class="secondary">- Secondary Page</a></li>
						<li><a href=""class="primary">Primary Page</a></li>
						<li><a href="" class="secondary">- Secondary Page</a></li>
						<li><a href="" class="tertiary">-- Tertiary Page</a></li>
						<li><a href=""  class="secondary">- Secondary Page</a></li>
						<li><a href=""  class="secondary">- Secondary Page</a></li>
						<li><a href=""  class="tertiary">-- Tertiary Page</a></li>
						<li><a href=""  class="tertiary">-- Tertiary Page</a></li>
